'''
Created on May 5th, 2014
Robert Micatka

Retrieves data from Yahoo Finance
This is based on Corey Goldberg's module:
http://www.goldb.org/ystockquote.html
'''

import urllib
from operator import itemgetter
from dataType import dailyStockType
from errors import Errors, mException
...
class yahooFinance(object):
    def __request(self, symbol, stat):
        try:
            ...
            raise mException(Errors.NETWORK_ERROR, "Can't connect to Yahoo server")
        except BaseException as excep:
            raise mException(Errors.UNKNOWN_ERROR, "Unknown Error in YahooFinance.__request %s" %excep)
    ...
    def get_historical_prices(self, symbol, start_date, end_date):
        ...
        try:
            ...
            for value in values[1:]:
                data.append(dailyStockType(value[0], value[1], value[2], value[3], value[4], value[5], value[6]))
            ...
            raise mException(Errors.UNKNOWN_ERROR, "Unknown Error in YahooFinance.get_historical_prices %s" % excep)
